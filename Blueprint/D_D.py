...
# This will import the database object, which is an instance of SQLAlchemy
# that is configured to connect to the database
from ..database import database

# Imports the DungeonsandDragons_game and DungeonsandDragons_player models,
# which maps to two separate tables in the database
